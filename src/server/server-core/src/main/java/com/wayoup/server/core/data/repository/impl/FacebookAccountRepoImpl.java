 ...
 */
@Repository("facebookAccountRepo")
public class FacebookAccountRepoImpl extends AbstractOrientRepo<UserFacebook> implements FacebookAccountRepo<UserFacebook> {

    private static final Logger logger = Logger.getLogger(AccountService.class.getName());

    @Override
    public UserFacebook findByExtId(String extId) throws DataException {
        try {
            String query = "select from " + UserFacebook.class.getSimpleName() + " where extId=? limit 1";
